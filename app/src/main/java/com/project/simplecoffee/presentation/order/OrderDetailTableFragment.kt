...
import com.project.simplecoffee.databinding.FragmentOrderDetailTableBinding
import com.project.simplecoffee.domain.model.Order
import dagger.hilt.android.AndroidEntryPoint
import javax.inject.Inject

@AndroidEntryPoint
class OrderDetailTableFragment : Fragment() {

    @Inject
    lateinit var orderDetailVM: OrderDetailTableVM
    private lateinit var binding: FragmentOrderDetailTableBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_order_detail_table,
            container, false
        )
        binding.apply {
